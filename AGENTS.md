...
- The Codex Preview MCP tool requires a running preview server started via `mcp__Claude_Preview__preview_start`.
...
- Co-author line: `Co-Authored-By: Codex Sonnet 4.6 <noreply@anthropic.com>`
