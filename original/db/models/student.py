...
if TYPE_CHECKING:
    from original.db.models.baseline import BaselineSample
    from original.db.models.course import Course
    from original.db.models.institution import Institution
    from original.db.models.submission import Submission
...
class Student(Base, UUIDMixin, TimestampMixin):
    ...
    baseline_kappa: Mapped[float | None] = mapped_column(
        Float,
        nullable=True,
        default=None,
