...
LOCALIZATION_GROUPS: Final = {
    ...
    "document": {
        ...
        # Tier 18 uniformity — every one is a second moment taken over the
        # whole document (a dispersion ratio against the student's baseline).
        # "This paper varies too little" is a statement about the spread of
        # the values, not about any one sentence, so there is no honest span
        # to highlight for it.
