...
export class NetworkPulseEngine {
  ...
  renderHierarchyIndex() {
    ...
    if (this.level === 'galaxy') {
      ...
      if (count) count.textContent = '109 WRITING TRAITS';
  ...
  updateInterface() {
    ...
    const aria = this.level === 'galaxy'
      ? 'Interactive writing-pattern galaxy with three named suns: Surface, Discourse, and Rhetoric; eighteen orbiting trait groups, one comparison orbit, and 109 writing traits'
      : this.level === 'system'
