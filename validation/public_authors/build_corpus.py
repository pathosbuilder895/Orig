...
ESSAYS: List[EssayRef] = [
    ...
    EssayRef(
        ...
        "G.K. Chesterton",
        "The Twelve Men",
        "https://en.wikisource.org/wiki/The_Twelve_Men",
        True,
    ),
    EssayRef(
        "chesterton",
        ...
        "https://en.wikisource.org/wiki/Tremendous_Trifles/On_Running_After_One%27s_Hat",
        True,
    ),
    EssayRef(
        "chesterton",
        "G.K. Chesterton",
        "A Piece of Chalk",
        "https://en.wikisource.org/wiki/Tremendous_Trifles/A_Piece_of_Chalk",
        True,
    ),
    EssayRef(
        "chesterton",
        ...
        "https://en.wikisource.org/wiki/Tremendous_Trifles/The_Dragon%27s_Grandmother",
        False,
    ),
    EssayRef(
        "chesterton",
        "G.K. Chesterton",
        "The Tower",
        "https://en.wikisource.org/wiki/Tremendous_Trifles/The_Tower",
        False,
    ),
    # ── John Henry Newman ──
    EssayRef(
        ...
        "https://en.wikisource.org/wiki/The_Idea_of_a_University_Defined_and_Illustrated/Discourse_8",
        True,
    ),
    EssayRef(
        "newman",
        ...
        "https://en.wikisource.org/wiki/The_Idea_of_a_University_Defined_and_Illustrated/Discourse_4",
        True,
    ),
    EssayRef(
        "newman",
        ...
        "https://en.wikisource.org/wiki/The_Idea_of_a_University_Defined_and_Illustrated/Discourse_5",
        True,
    ),
    EssayRef(
        "newman",
        ...
        "https://en.wikisource.org/wiki/The_Idea_of_a_University_Defined_and_Illustrated/Discourse_7",
        False,
    ),
    EssayRef(
        "newman",
        ...
        "https://en.wikisource.org/wiki/The_Idea_of_a_University_Defined_and_Illustrated/Discourse_6",
        False,
    ),
    ...
    EssayRef(
        ...
        "William James",
        "Habit",
        "https://en.wikisource.org/wiki/The_Principles_of_Psychology/Chapter_4",
        True,
    ),
    EssayRef(
        "james",
        "William James",
        "Stream of Thought",
        "https://en.wikisource.org/wiki/The_Principles_of_Psychology/Chapter_9",
        True,
    ),
    EssayRef(
        "james",
        "William James",
        "Will to Believe",
        "https://en.wikisource.org/wiki/The_Will_to_Believe_(essay)",
        True,
    ),
    EssayRef(
        "james",
        ...
        "https://en.wikisource.org/wiki/Pragmatism:_A_New_Name_for_Some_Old_Ways_of_Thinking/Lecture_II",
        False,
    ),
    EssayRef(
        "james",
        ...
        "https://en.wikisource.org/wiki/Some_Problems_of_Philosophy/Chapter_1",
        False,
    ),
    # ── Ralph Waldo Emerson ──
    EssayRef(
    ...
    EssayRef(
        ...
        "On Religion Speech I",
        "https://en.wikisource.org/wiki/On_Religion:_Speeches_to_Its_Cultured_Despisers/First_Speech",
        True,
    ),
    EssayRef(
        "schleiermacher",
        "Friedrich Schleiermacher",
        "On Religion Speech II",
        "https://en.wikisource.org/wiki/On_Religion:_Speeches_to_Its_Cultured_Despisers/Second_Speech",
        True,
    ),
    EssayRef(
        "schleiermacher",
        "Friedrich Schleiermacher",
        "On Religion Speech III",
        "https://en.wikisource.org/wiki/On_Religion:_Speeches_to_Its_Cultured_Despisers/Third_Speech",
        True,
    ),
    EssayRef(
        "schleiermacher",
        "Friedrich Schleiermacher",
        "On Religion Speech IV",
        "https://en.wikisource.org/wiki/On_Religion:_Speeches_to_Its_Cultured_Despisers/Fourth_Speech",
        False,
    ),
    EssayRef(
        "schleiermacher",
        "Friedrich Schleiermacher",
        "On Religion Speech V",
        "https://en.wikisource.org/wiki/On_Religion:_Speeches_to_Its_Cultured_Despisers/Fifth_Speech",
        False,
    ),
    ...
    EssayRef(
        ...
        "https://en.wikisource.org/wiki/The_Hypocrisy_of_American_Slavery",
        True,
    ),
    EssayRef(
        "douglass",
        ...
        "https://en.wikisource.org/wiki/The_Constitution_of_the_United_States:_Is_It_Pro-Slavery_or_Anti-Slavery%3F",
        True,
    ),
    EssayRef(
        "douglass",
        "Frederick Douglass",
        "Self-Made Men",
        "https://en.wikisource.org/wiki/Self-Made_Men",
        False,
    ),
    EssayRef(
        "douglass",
        ...
        "https://en.wikisource.org/wiki/An_Address_to_the_Colored_People_of_the_United_States",
        False,
    ),
    # ── Henry David Thoreau ──
    EssayRef(
        ...
        "Henry David Thoreau",
        "Civil Disobedience",
        "https://en.wikisource.org/wiki/Resistance_to_Civil_Government_(Thoreau)",
        True,
    ),
    EssayRef(
        "thoreau",
        "Henry David Thoreau",
        "Walking",
        "https://en.wikisource.org/wiki/Walking_(Thoreau)",
        True,
    ),
    EssayRef(
        "thoreau",
    ...
    EssayRef(
        ...
        "John Stuart Mill",
        "On Liberty Ch.1",
        "https://en.wikisource.org/wiki/On_Liberty/Chapter_I",
        True,
    ),
    EssayRef(
        "mill",
        "John Stuart Mill",
        "On Liberty Ch.2",
        "https://en.wikisource.org/wiki/On_Liberty/Chapter_II",
        True,
    ),
    EssayRef(
        "mill",
        "John Stuart Mill",
        "On Liberty Ch.3",
        "https://en.wikisource.org/wiki/On_Liberty/Chapter_III",
        True,
    ),
    EssayRef(
        "mill",
        "John Stuart Mill",
        "On Liberty Ch.4",
        "https://en.wikisource.org/wiki/On_Liberty/Chapter_IV",
        False,
    ),
    EssayRef(
        "mill",
        "John Stuart Mill",
        "On Liberty Ch.5",
        "https://en.wikisource.org/wiki/On_Liberty/Chapter_V",
        False,
    ),
]
...
GUTENBERG_WORKS: List[GutenbergWork] = [
    ...
    GutenbergWork(
        "kempis", "Thomas à Kempis", "The Imitation of Christ", pg_id=1653, n_chunks=5, n_baseline=3
    ),
...
def _build_from_gutenberg(
    ...
    if body_path.exists() and not force:
        ...
        print(
            f"  cached: {work.author_id}/_full_work_cache.txt " f"({len(body.split())} words)",
            flush=True,
        )
    else:
        try:
...
def _strip_html(html: str) -> str:
    ...
    m = re.search(
        r'<div class="mw-parser-output"[^>]*>(.*?)</div>\s*(?:<!--|<noscript)',
        html,
    ...
    body = re.sub(
        r'<div class="(hatnote|reflist|noprint|references|catlinks)[^"]*"[^>]*>.*?</div>',
        "",
        body,
        flags=re.DOTALL | re.IGNORECASE,
    )
    ...
    # Drop footnotes ([1], [2], ...).
    body = re.sub(
        r'<sup[^>]*class="reference"[^>]*>.*?</sup>', "", body, flags=re.DOTALL | re.IGNORECASE
    )
    ...
    for ref in ESSAYS:
        ...
        if path.exists() and not force:
            ...
            if len(text.split()) < 300:
                print(
                    f"  SKIP (too short after strip): {ref.author_id}/{slug}.txt — {len(text.split())} words",
                    flush=True,
                )
                skipped.append(relpath)
                continue
        ...
        authors.setdefault(
            ref.author_id,
            {"name": ref.author_name, "native_english": ref.author_id != "schleiermacher"},
        )
        entries.append(
            {
                "filename": relpath,
