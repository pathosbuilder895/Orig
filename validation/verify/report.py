...
def paths_for(label: str, *, base: str = "validation/benchmarks") -> VerifyPaths:
    ...
    return VerifyPaths(root=root, json_path=root / "report.json", md_path=root / "report.md")
    ...
    *,
    ...
    j = {
        ...
        "summary": {
            ...
            "pooled_uncalibrated_auc_ci_95": [
                report.pooled_uncalibrated_auc_ci_lo,
...
def _render_markdown(j: dict) -> str:
    ...
    lines.append("")
    lines.append(
        "Concatenates every author's rows into one AUC. NOT directly "
    ...
    lines.append("")
    lines.append(
        f"- **AUC**: {s['pooled_uncalibrated_auc']}  "
    ...
    lines.append("")
    lines.append(
        "| author | n_same | n_diff | AUC | 95% CI | Brier | "
